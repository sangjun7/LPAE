...
#=======================================================================================================================================
parser = argparse.ArgumentParser(description='WAE + ResNet50 finetune for ImageNet')
...
parser.add_argument('--model_name', default='resnet50_of_papersetting_imagenet_combine_finetune.pth', help='Name for trained model')
parser.add_argument('--pretrained_AE', default='./model_save/wae_papersetting_imagenet.pth', help='pretrained WAE parameters')
parser.add_argument('--pretrained_resnet', default='./model_save/resnet50_of_papersetting_imagenet_combine.pth', help='pretrained ResNet parameters')
