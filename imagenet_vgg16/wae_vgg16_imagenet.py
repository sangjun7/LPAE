...
#=======================================================================================================================================
parser = argparse.ArgumentParser(description='WAE + VGG16 for ImageNet')
...
parser.add_argument('--model_name', default='vgg_of_papersetting_imagenet_combine.pth', help='Name for trained model')
