...
#=======================================================================================================================================
parser = argparse.ArgumentParser(description='WAE + VGG16 finetune for ImageNet')
...
parser.add_argument('--model_name', default='vgg_of_papersetting_imagenet_combine_finetune.pth', help='Name for trained model')
parser.add_argument('--pretrained_AE', default='./model_save/wae_papersetting_imagenet.pth', help='pretrained WAE parameters')
parser.add_argument('--pretrained_vgg', default='./model_save/vgg_of_papersetting_imagenet_combine.pth', help='pretrained VGG parameters')
