...
#=======================================================================================================================================
parser = argparse.ArgumentParser(description='LPAE for ImageNet')
...
parser.add_argument('--model_name', default='wae_change_structure_imagenet_rec_l1.pth', help='Name for trained model')
