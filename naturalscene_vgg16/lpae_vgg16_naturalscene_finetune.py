...
#=======================================================================================================================================
parser = argparse.ArgumentParser(description='LPAE + VGG16 finetune for NaturalScene')
...
parser.add_argument('--model_name', default='vgg_of_change_structure_rec_l1_naturalscene_combine_finetune.pth', help='Name for trained model')
...
parser.add_argument('--pretrained_vgg', default='./model_save/vgg_of_change_structure_rec_l1_naturalscene_combine.pth', help='pretrained VGG parameters')
