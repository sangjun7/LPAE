...
#=======================================================================================================================================
parser = argparse.ArgumentParser(description='LPAE + VGG16 for NaturalScene')
...
parser.add_argument('--model_name', default='vgg_of_change_structure_rec_l1_naturalscene_combine.pth', help='Name for trained model')
