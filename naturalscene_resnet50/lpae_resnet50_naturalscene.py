...
#=======================================================================================================================================
parser = argparse.ArgumentParser(description='LPAE + ResNet50 for NaturalScene')
...
parser.add_argument('--model_name', default='resnet50_of_change_structure_rec_l1_naturalscene_combine.pth', help='Name for trained model')
