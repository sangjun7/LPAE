...
#=======================================================================================================================================
parser = argparse.ArgumentParser(description='LPAE + ResNet50 finetune for NaturalScene')
...
parser.add_argument('--model_name', default='resnet50_of_change_structure_rec_l1_naturalscene_combine_finetune.pth', help='Name for trained model')
parser.add_argument('--pretrained_AE', default='./model_save/wae_change_structure_naturalscene_rec_l1.pth', help='pretrained LPAE parameters')
parser.add_argument('--pretrained_resnet', default='./model_save/resnet50_of_change_structure_rec_l1_naturalscene_combine.pth', help='pretrained ResNet parameters')
