...
parser.add_argument('--model_name', default='wae_srnet_structure_change_rec_l1_div2k_2mag.pth', help='Name for trained model')
parser.add_argument('--pretrained_AE', default='./model_save/wae_change_structure_div2k_rec_l1.pth', help='pretrained LPAE parameters')
