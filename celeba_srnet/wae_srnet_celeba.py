...
#=======================================================================================================================================
parser = argparse.ArgumentParser(description='WAE + SRNet for CelebA')
...
parser.add_argument('--model_name', default='waveletlike_autoencoder_srnet_face_2mag.pth', help='Name for trained model')
parser.add_argument('--pretrained_AE', default='./model_save/wae_papersetting_face.pth', help='pretrained WAE parameters')
