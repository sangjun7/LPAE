...
#=======================================================================================================================================
parser = argparse.ArgumentParser(description='LPAE for CelebA')
parser.add_argument('--nepoch', default=30, type=int, help='Number of training epochs')
parser.add_argument('--lr', default=1e-2, type=float, help='Initial learning rate')
parser.add_argument('--lr_schedule', default=5, type=int, help='Decay period of learning rate')
...
parser.add_argument('--traindata', default='/home/sjhan/datasets/celeba/img_align_celeba/celeba_train', help='Path for train dataset')
parser.add_argument('--testdata', default='/home/sjhan/datasets/celeba/img_align_celeba/celeba_test', help='Path for validation dataset')

parser.add_argument('--model_save', default='./model_save', help='Path to save trained model')
parser.add_argument('--model_name', default='wae_change_structure_face_rec_l1.pth', help='Name for trained model')
...
def train_reset(batchSize, dataroot, workers=args.workers, resize=True, resizesz=144, rancrop=True, rancropsz=128, horiflip=True):
    trans_list = []
    if resize:
...
#=======================================================================================================================================
    ...
    for epoch in range(args.nepoch):        
        loss_sum = 0
        trainloader = train_reset(args.trainbatch, args.traindata, workers=args.workers, resize=True, resizesz=144, rancrop=True, rancropsz=128, horiflip=True)
